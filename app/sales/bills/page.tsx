            ...
            {sidebarItems.map((item, index) => (
              <Link
                ...
                className={`block px-4 py-2 text-sm ${
                  item.label === "账单列表" ? "bg-blue-50 text-blue-500" : "text-gray-600 hover:bg-gray-50"
                }`}
              >
                {item.label}
              </Link>
        ...
        <main className="flex-1 bg-[#f5f5f5]">
          ...
          <div className="bg-white border-b">
            <div className="flex">
              ...
              <Link href="/sales/bills" className="px-4 py-2 text-sm text-blue-500 border-b-2 border-blue-500">
                账单列表
              </Link>
            </div>
          </div>
            ...
            <div className="bg-white rounded shadow">
              ...
              <div className="p-4">
                <div className="grid grid-cols-4 gap-4 mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">消费包厢:</span>
                    <Input placeholder="请选择包厢" className="flex-1" />
                  </div>
                </div>

                <div className="grid grid-cols-4 gap-4">
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">账单号:</span>
                    <Input placeholder="请输入账单号" className="flex-1" />
                  </div>
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">预定信息:</span>
                    <Input placeholder="请输入预定信息" className="flex-1" />
                  </div>
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">接班指导人:</span>
                    <Input placeholder="请输入接班指导人" className="flex-1" />
                  </div>
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">包厢类型:</span>
              ...
              <div className="px-4 py-3 bg-gray-50 border-t border-b">
                <div className="flex items-center space-x-8">
                  ...
                  <div className="flex items-center">
                    <span className="text-sm text-gray-500">实收金额: </span>
                    <span className="text-sm ml-1">0.00</span>
                  </div>
                  <div className="flex items-center">
                ...
                <table className="w-full">
                  <thead>
                    <tr className="text-sm text-gray-500">
                      <th className="text-left py-2 font-normal">账单序号</th>
                      <th className="text-left py-2 font-normal">消费门店</th>
                      <th className="text-left py-2 font-normal">包厢类型</th>
                      <th className="text-left py-2 font-normal">消费包厢</th>
                      <th className="text-left py-2 font-normal">区域</th>
                      <th className="text-left py-2 font-normal">账单号</th>
                      <th className="text-left py-2 font-normal">开房类型</th>
                      <th className="text-right py-2 font-normal">消费金额</th>
                      <th className="text-right py-2 font-normal">实收金额</th>
                      <th className="text-right py-2 font-normal">退款金额</th>
                      <th className="text-left py-2 font-normal">预定信息</th>
                      <th className="text-left py-2 font-normal">发票情况</th>
                      <th className="text-left py-2 font-normal">发票金额</th>
                      <th className="text-left py-2 font-normal">接班指导人</th>
