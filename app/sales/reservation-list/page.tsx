            ...
            {sidebarItems.map((item, index) => (
              <Link
                ...
                className={`block px-4 py-2 text-sm ${
                  item.label === "预定列表" ? "bg-blue-50 text-blue-500" : "text-gray-600 hover:bg-gray-50"
                }`}
              >
                {item.label}
              </Link>
            ...
            <div className="bg-white rounded shadow">
              ...
              <div className="p-4">
                <div className="grid grid-cols-4 gap-4 mb-4">
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">包厢区域:</span>
                ...
                <div className="grid grid-cols-4 gap-4 mb-4">
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">包厢号:</span>
                    <Select defaultValue="all">
                      <SelectTrigger>
                        <SelectValue placeholder="全部" />
                      </SelectTrigger>
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">预定员工:</span>
                    <Select defaultValue="all">
                      <SelectTrigger>
                        <SelectValue placeholder="全部" />
                      </SelectTrigger>
                  ...
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">客户电话:</span>
                    <Input placeholder="请输入客户电话" className="flex-1" />
                  </div>
                </div>

                <div className="grid grid-cols-4 gap-4 mb-4">
                  <div className="col-span-2 flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">预定到店时间:</span>
                    <Input type="datetime-local" className="flex-1" defaultValue="2025-03-14 08:00" />
                    <span className="text-sm text-gray-500">-</span>
                    <Input type="datetime-local" className="flex-1" defaultValue="2025-03-15 08:00" />
                  </div>
                  <div className="flex items-center space-x-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">组次:</span>
                    <Select defaultValue="all">
                      <SelectTrigger>
                        <SelectValue placeholder="全部" />
                      </SelectTrigger>
                      <SelectContent>
                        <SelectItem value="all">全部</SelectItem>
                        <SelectItem value="1">第一组</SelectItem>
                        <SelectItem value="2">第二组</SelectItem>
                        <SelectItem value="3">第三组</SelectItem>
                      </SelectContent>
                    </Select>
                  </div>
                  <div className="flex items-center space-x-2">
                ...
                <div className="flex items-center space-x-2">
                  <span className="text-sm text-gray-500 whitespace-nowrap">备注:</span>
                  <Input placeholder="请输入备注" className="w-80" />
                </div>
              </div>
                ...
                <table className="w-full">
                  <thead>
                    <tr className="text-sm text-gray-500">
                      <th className="text-left py-2 font-normal">预定号</th>
                      <th className="text-left py-2 font-normal">预定时间</th>
                      <th className="text-left py-2 font-normal">包厢号</th>
                      <th className="text-left py-2 font-normal">包厢类型</th>
                      <th className="text-left py-2 font-normal">包厢区域</th>
                      <th className="text-left py-2 font-normal">预定员工</th>
                      <th className="text-left py-2 font-normal">客户姓名</th>
                      <th className="text-left py-2 font-normal">客户电话</th>
                      <th className="text-left py-2 font-normal">到店人数</th>
                      <th className="text-left py-2 font-normal">预定到店时间</th>
                      <th className="text-left py-2 font-normal">状态</th>
                      <th className="text-left py-2 font-normal">操作人</th>
                      <th className="text-left py-2 font-normal">组次</th>
